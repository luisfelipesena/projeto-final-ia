...
\begin{frame}{RNA para LIDAR: Detecção de Obstáculos}
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \textbf{Output: Mapa de 8 Setores}
            \begin{center}
                \includegraphics[width=0.85\textwidth]{lidar_sectors_light.png}
            \end{center}
...
\begin{frame}{Funções de Pertinência - Entradas}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{mf_inputs_combined.png}
    \end{center}

    \vspace{0.5em}
    \textbf{5 MFs por distância:} Muito Perto | Perto | Médio | Longe | Muito Longe

    \textbf{7 MFs por ângulo:} Neg. Grande | Neg. Médio | Neg. Pequeno | Zero | Pos. Pequeno | Pos. Médio | Pos. Grande
\end{frame}

\begin{frame}{Funções de Pertinência - Saídas}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{mf_outputs_combined.png}
    \end{center}

    \vspace{0.5em}
    \textbf{Velocidade Linear:} Parar | Devagar | Médio | Rápido

    \textbf{Velocidade Angular:} Esq. Forte | Esquerda | Reto | Direita | Dir. Forte

    \textbf{Defuzzificação:} Método do Centróide | Latência <50ms
\end{frame}
