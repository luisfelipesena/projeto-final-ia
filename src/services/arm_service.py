...
"""
from actuators.arm_controller import ArmHeight, ArmOrientation
...
class ArmService:
    ...
    def is_gripping(self) -> bool:
        ...
        # Use new GripperController property if available, else fallback
        if hasattr(self.gripper, 'is_closed_commanded'):
            return self.gripper.is_closed_commanded
        return False
    ...
    def execute_grasp(self, use_ik: bool = False, forward_reach: float = 0.25, lateral_offset: float = 0.0):
        ...
        try:
            ...
            print(f"[GRASP] Gripper check: {sensor_info}, has_object={has_object}")
